...
//        if (!flag && num > 700) {
//            flag = true;
//            String para = "door-energy-checkout/" + request.getLocalAddr() + ":" + request.getServerPort();
//            rabbitTemplate.convertAndSend("door-energy-checkout", "door-energy-checkout", para);
//        }
//        if (flag) {
//            try {
//                Thread.sleep(100);
