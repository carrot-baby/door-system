...
import springcloud.controller.WebController;

import java.util.*;

@Component
public class NodeRule8080 extends RoundRobinRule {
    ...
    public NodeRule8080(ILoadBalancer lb) {
        super(lb);
    }
    ...
    public Server choose(ILoadBalancer lb, Object key) {
        ...
        if (num > 50) {
            ...
            HashMap<String, LinkedHashMap<String, Double>> serviceMap = WebController.serviceMap;
