...
import springcloud.controller.GetAccept6Controller;

import java.util.*;

@Component
public class NodeRule275 extends RoundRobinRule {
    ...
    public NodeRule275(ILoadBalancer lb) {
        super(lb);
    }
    ...
    public Server choose(ILoadBalancer lb, Object key) {
        ...
        if (num > 50) {
            ...
            HashMap<String, LinkedHashMap<String, Double>> serviceMap = GetAccept6Controller.serviceMap;
